...
# Build paths inside the pereval like this: BASE_DIR / 'subdir'.
...
SECRET_KEY = 'django-insecure-h2(d!bb5u4*6_ew14n6zm+u%2%eyc&=q#371w7x+loit^dol)3'
...
DATABASES = {
    'default': {
        ...
        'USER': str(os.getenv('FSTR_DB_USER')),
